...
import { BrainCircuit, ArrowRight, Mail, Lock, Eye, EyeOff, Github } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center font-outfit px-6">
            <div className="w-full max-w-[340px] bg-white p-6 rounded-[1.5rem] border border-slate-200 shadow-xl shadow-slate-200/50">
                <div className="mb-6 text-center">
                    ...
                    <h1 className="text-xl font-extrabold text-slate-900 tracking-tight mb-1">Sign In</h1>
                    <p className="text-slate-500 text-[12px] font-medium leading-tight">Access your <span className="font-bold text-blue-600">SmartLearn AI</span> account.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-3">
                    ...
                    <button
                        disabled={loading}
                        className="w-full py-2.5 bg-slate-900 text-white font-bold rounded-lg hover:bg-slate-800 transition-all flex items-center justify-center space-x-2 shadow-lg disabled:opacity-50 text-xs"
                    >
                ...
                <div className="mt-8 text-center">
                    <p className="text-xs text-slate-400 font-bold">
                        New User?
                        <Link href="/signup" className="text-blue-600 ml-2 hover:underline">Sign Up</Link>
                    </p>
                </div>
            </div>
        </div>
